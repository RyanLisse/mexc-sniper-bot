...
- Name: Take Profit Levels Configuration >> should allow modification of take profit level 3 (15%)
- Location: /Users/neo/Developer/mexc-sniper-bot/all-tests/e2e-tests/take-profit-levels.spec.ts:127:7
...
Call log:
  - → POST http://localhost:3008/api/user-preferences
    ...
    at /Users/neo/Developer/mexc-sniper-bot/all-tests/e2e-tests/take-profit-levels.spec.ts:131:47
```
