...
- Name: Authentication Frontend Integration >> Data isolation - different users have different preferences
- Location: /Users/neo/Developer/mexc-sniper-bot/all-tests/e2e-tests/test-auth-frontend.spec.ts:159:7
...
Call log:
  - waiting for locator('button:has-text("Edit Levels")')

    at /Users/neo/Developer/mexc-sniper-bot/all-tests/e2e-tests/test-auth-frontend.spec.ts:169:16
```
