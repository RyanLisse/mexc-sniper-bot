...
Call log:
  ...
  - waiting for locator('h1')
    6 × locator resolved to <h1 class="text-6xl font-bold text-gray-900 mb-6">MEXC Sniper Bot</h1>
      - unexpected value "MEXC Sniper Bot"

    at /Users/neo/Developer/mexc-sniper-bot/all-tests/e2e-tests/dashboard.spec.ts:11:38
```
