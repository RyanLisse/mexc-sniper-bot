...
- Name: Authentication Protection Verification >> Server-side protection works with direct requests
- Location: /Users/neo/Developer/mexc-sniper-bot/all-tests/e2e-tests/auth-protection-simple.spec.ts:102:7
...
Received array: [301, 302, 307, 308]
    at /Users/neo/Developer/mexc-sniper-bot/all-tests/e2e-tests/auth-protection-simple.spec.ts:110:34
```
...
> 110 |     expect([301, 302, 307, 308]).toContain(dashboardResponse.status());
  ...
  143 |     expect(location).toBe('/');
  144 |     
  145 |     console.log('✅ Middleware headers correct');
  146 |   });
  147 | });
```