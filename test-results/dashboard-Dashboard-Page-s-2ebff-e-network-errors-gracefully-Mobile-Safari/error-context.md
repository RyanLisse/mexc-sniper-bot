...
- Name: Dashboard Page >> should handle network errors gracefully
- Location: /Users/neo/Developer/mexc-sniper-bot/all-tests/e2e-tests/dashboard.spec.ts:124:7
...
Call log:
  - navigating to "http://localhost:3008/dashboard", waiting until "load"
    ...
    at /Users/neo/Developer/mexc-sniper-bot/all-tests/e2e-tests/dashboard.spec.ts:125:16
```
