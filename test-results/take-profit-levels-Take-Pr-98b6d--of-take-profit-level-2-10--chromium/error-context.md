...
- Name: Take Profit Levels Configuration >> should allow modification of take profit level 2 (10%)
- Location: /Users/neo/Developer/mexc-sniper-bot/all-tests/e2e-tests/take-profit-levels.spec.ts:92:7
...
Call log:
  - → POST http://localhost:3008/api/user-preferences
    ...
    at /Users/neo/Developer/mexc-sniper-bot/all-tests/e2e-tests/take-profit-levels.spec.ts:96:47
```
