...
- Name: Authentication Protection Verification >> Auth page is accessible to anonymous users
- Location: /Users/neo/Developer/mexc-sniper-bot/all-tests/e2e-tests/auth-protection-simple.spec.ts:62:7
...
Call log:
  - navigating to "http://localhost:3008/auth", waiting until "load"
    ...
    at /Users/neo/Developer/mexc-sniper-bot/all-tests/e2e-tests/auth-protection-simple.spec.ts:65:16
```
