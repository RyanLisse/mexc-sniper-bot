...
def decrypt_api_credentials(encrypted_data: dict) -> dict:
    ...
    return {
        "api_key": service.decrypt(encrypted_data.get("api_key_encrypted", ""))
        if encrypted_data.get("api_key_encrypted")
        else None,
        "secret_key": service.decrypt(encrypted_data.get("secret_key_encrypted", ""))
        if encrypted_data.get("secret_key_encrypted")
        else None,
        "passphrase": service.decrypt(encrypted_data.get("passphrase_encrypted", ""))
