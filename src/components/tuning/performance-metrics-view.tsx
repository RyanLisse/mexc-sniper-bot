    ...
    const summaries: MetricSummary[] = [
      {
        ...
        trend:
          latest.responseTime > previous.responseTime * 1.1
            ? "up"
            : latest.responseTime < previous.responseTime * 0.9
              ? "down"
              : "stable",
        status:
          latest.responseTime <= 500
            ? "healthy"
            : latest.responseTime <= 2000
              ? "warning"
              : "critical",
      },
      {
        ...
        trend:
          latest.throughput > previous.throughput * 1.1
            ? "up"
            : latest.throughput < previous.throughput * 0.9
              ? "down"
              : "stable",
        status:
      ...
      },
      {
        ...
        trend:
          latest.errorRate > previous.errorRate * 1.1
            ? "up"
            : latest.errorRate < previous.errorRate * 0.9
              ? "down"
              : "stable",
        status:
      ...
      },
      {
        ...
        trend:
          latest.successRate > previous.successRate * 1.01
            ? "up"
            : latest.successRate < previous.successRate * 0.99
              ? "down"
              : "stable",
        status:
          latest.successRate >= 0.99
            ? "healthy"
            : latest.successRate >= 0.95
              ? "warning"
              : "critical",
      },
      {
        ...
        trend:
          latest.cpuUsage > previous.cpuUsage * 1.1
            ? "up"
      ...
      },
      {
        ...
        trend:
          latest.memoryUsage > previous.memoryUsage * 1.1
            ? "up"
            : latest.memoryUsage < previous.memoryUsage * 0.9
              ? "down"
              : "stable",
        status:
          latest.memoryUsage <= 512
            ? "healthy"
            : latest.memoryUsage <= 1024
              ? "warning"
              : "critical",
      },
    ];
