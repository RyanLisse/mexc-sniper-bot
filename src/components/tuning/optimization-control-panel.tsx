  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => {
                      if (checked) {
                        ...
                        setConfig({
                          ...config,
                          parameterCategories: config.parameterCategories.filter(c => c !== category.value)
                        });
                      }
                    }}
                  />
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <Alert>
            ...
            <AlertDescription>
              Objective weights must sum to 1.0. Current total: {config.objectives.reduce((sum, obj) => sum + obj.weight, 0).toFixed(2)}
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>
          ...
          <div>
            <label className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) => setConfig({ ...config, enableBacktesting: !!checked })}
              />
            ...
            {config.enableBacktesting && (
              <div className="mt-2">
                ...
                <Input
                  ...
                  onChange={(e) => setConfig({ ...config, backtestingPeriodDays: parseInt(e.target.value) })}
                  min={7}
                  max={365}
                />
              </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div>
            <Label>Maximum Risk Level: {(config.safetyConstraints.maxRiskLevel * 100).toFixed(0)}%</Label>
            <Slider
            ...
            <Input
              ...
              onChange={(e) => setConfig({
                ...
                safetyConstraints: { 
                  ...
                  minSharpeRatio: parseFloat(e.target.value) 
                }
              })}
              min={0}
              max={5}
          ...
          <div>
            <Label>Maximum Drawdown: {(config.safetyConstraints.maxDrawdown * 100).toFixed(0)}%</Label>
            <Slider
                  ...
                  {systemHealth && (
                    <div className="space-y-1 text-sm">
                      <div className="flex justify-between">
                        ...
                        <span className="capitalize">{systemHealth.components.optimizationEngine}</span>
                      </div>
                      <div className="flex justify-between">
                        <span>Parameter Manager:</span>
                        <span className="capitalize">{systemHealth.components.parameterManager}</span>
                      </div>
                      <div className="flex justify-between">
              ...
              <div>
                ...
                <div className="space-y-3">
                  <Button
                    ...
                    disabled={!isConfigValid || isStarting || systemHealth?.overallHealth === 'critical'}
                    className="w-full"
                    size="lg"
                  >
