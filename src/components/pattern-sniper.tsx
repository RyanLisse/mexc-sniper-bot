...
export const PatternSniperComponent: FC = memo(
  function PatternSniperComponent() {
    const {
      isMonitoring,
      isConnected,
      calendarTargets,
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-slate-400">
              Real-time pattern detection and automated execution
            </p>
          </div>
        ...
        <Card className="bg-slate-800/50 border-slate-700">
          <CardHeader>
            ...
            <CardDescription>
              Manage pattern detection and automated sniping
            </CardDescription>
          </CardHeader>
          <CardContent>
                ...
                {readyTargets.map((target) => (
                  ...
                  >
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        ...
                        <div className="flex items-center space-x-4 mt-2 text-sm text-slate-400">
                          ...
                          <span>
                            Precision: {target.priceDecimalPlaces}/
                            {target.quantityDecimalPlaces}
                          </span>
                        </div>
                      </div>
                      <div className="flex space-x-2">
                        ...
                        <Button
                          ...
                          variant="outline"
                          onClick={() =>
                            handleRemoveTarget(normalizeVcoinId(target.vcoinId))
                          }
                    ...
                    <div className="mt-3 p-2 bg-slate-700/50 rounded text-xs">
                      <strong>Order Params:</strong>{" "}
                      {JSON.stringify(target.orderParameters, null, 2)}
                    </div>
                  </div>
                ))}
              </div>
        ...
        {calendarTargets.length > 0 && (
          <Card className="bg-slate-800/50 border-slate-700">
            <CardHeader>
              ...
              <CardDescription>
                Detected from MEXC calendar feed
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-2">
          ...
          <Card className="bg-slate-800/50 border-slate-700">
            <CardContent className="text-center py-12">
              ...
              <p className="text-slate-500 mb-4">
                Start monitoring to detect new MEXC listings and ready state
                patterns
              </p>
              <Button
