...
export const SafetyMonitoringDashboard = memo(
  function SafetyMonitoringDashboard() {
    ...
    const handleEmergencyHalt = useCallback(() => {
      emergencyHalt({
        reason: "Manual emergency halt triggered from dashboard",
      });
    }, [emergencyHalt]);
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Automatic trading halts based on risk thresholds
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex items-center justify-between">
              ...
              <Badge
                variant={
                  riskMetrics?.circuitBreakerStatus === "closed"
                    ? "default"
                    : "destructive"
                }
              >
            ...
            <div className="flex items-center justify-between mt-2">
              ...
              <Badge
                variant={
                  riskMetrics?.emergencyHaltActive ? "destructive" : "secondary"
                }
              >
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Current risk assessment and position limits
            </CardDescription>
          </CardHeader>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Virtual trading environment for safe testing
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Performance metrics from simulation trading
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
