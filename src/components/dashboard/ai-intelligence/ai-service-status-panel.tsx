  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          {data.overall.message} ({data.overall.availableServices}/
          {data.overall.totalServices} services)
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          <div className="flex justify-between text-sm">
            ...
            <span>
              {Math.round(
                (data.overall.availableServices / data.overall.totalServices) *
                  100
              )}
              %
            </span>
        ...
        <div className="border-t pt-4">
          ...
          <div className="grid grid-cols-1 gap-2">
            <div className="flex items-center justify-between">
              ...
              <Badge
                variant={
                  data.capabilities.patternEmbedding ? "default" : "outline"
                }
              >
                {data.capabilities.patternEmbedding
                  ? "Available"
                  : "Unavailable"}
              </Badge>
            </div>
            <div className="flex items-center justify-between">
              ...
              <Badge
                variant={
                  data.capabilities.marketResearch ? "default" : "outline"
                }
              >
            ...
            <div className="flex items-center justify-between">
              ...
              <Badge
                variant={
                  data.capabilities.fallbackAnalysis ? "default" : "outline"
                }
              >
                {data.capabilities.fallbackAnalysis
                  ? "Available"
                  : "Unavailable"}
              </Badge>
            </div>
