...
export function sanitizePassword(password: string): string {
  ...
  // biome-ignore lint/suspicious/noControlCharactersInRegex: Legitimate use for removing dangerous control characters from passwords
...
export function sanitizeText(text: string): string {
  ...
  // biome-ignore lint/suspicious/noControlCharactersInRegex: Legitimate use for removing dangerous control characters from user input
  sanitized = sanitized.replace(/[\x00-\x08\x0B\x0C\x0E-\x1F\x7F]/g, "");
