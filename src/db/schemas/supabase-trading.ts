...
// API Credentials Table - Supabase compatible
...
// Execution History Table - Supabase compatible
...
// Transactions Table - Supabase compatible
export const transactions = pgTable(
  "transactions",
  {
    ...
    buyTimestamp: timestamp("buy_timestamp", { withTimezone: true }),
    ...
    sellTimestamp: timestamp("sell_timestamp", { withTimezone: true }),
...
// Transaction Lock Tables - Supabase compatible
...
// Balance Snapshots Table - Supabase compatible
...
// Portfolio Summary Table - Supabase compatible
...
// Trading Types - Supabase compatible
