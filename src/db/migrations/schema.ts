import { pgTable, serial, text, timestamp, real, integer, boolean, index, unique, foreignKey } from "drizzle-orm/pg-core"
...
export const errorIncidents = pgTable("error_incidents", {
	id: text().primaryKey().notNull(),
	type: text().notNull(),
	severity: text().notNull(),
	...
	index("error_incidents_first_occurrence_idx").using("btree", table.firstOccurrence.asc().nullsLast().op("timestamp_ops")),
	index("error_incidents_last_occurrence_idx").using("btree", table.lastOccurrence.asc().nullsLast().op("timestamp_ops")),
	index("error_incidents_recovered_idx").using("btree", table.recovered.asc().nullsLast().op("bool_ops")),
	index("error_incidents_service_idx").using("btree", table.service.asc().nullsLast().op("text_ops")),
	index("error_incidents_service_severity_idx").using("btree", table.service.asc().nullsLast().op("text_ops"), table.severity.asc().nullsLast().op("text_ops")),
	index("error_incidents_severity_idx").using("btree", table.severity.asc().nullsLast().op("text_ops")),
	index("error_incidents_type_idx").using("btree", table.type.asc().nullsLast().op("text_ops")),
	index("error_incidents_type_occurrence_idx").using("btree", table.type.asc().nullsLast().op("text_ops"), table.lastOccurrence.asc().nullsLast().op("text_ops")),
]);
...
export const monitoredListings = pgTable("monitored_listings", {
	...
	lastChecked: timestamp("last_checked", { mode: 'string' }).default(sql`CURRENT_TIMESTAMP`).notNull(),
	...
	index("idx_monitored_listings_pattern_ready").using("btree", table.hasReadyPattern.asc().nullsLast().op("text_ops"), table.status.asc().nullsLast().op("bool_ops"), table.confidence.asc().nullsLast().op("float4_ops")).where(sql`(has_ready_pattern = true)`),
...
export const reconciliationReports = pgTable("reconciliation_reports", {
	...
	index("reconciliation_reports_critical_issues_idx").using("btree", table.criticalIssues.asc().nullsLast().op("int4_ops")),
	index("reconciliation_reports_overall_status_idx").using("btree", table.overallStatus.asc().nullsLast().op("text_ops")),
	index("reconciliation_reports_start_time_idx").using("btree", table.startTime.asc().nullsLast().op("timestamp_ops")),
	index("reconciliation_reports_user_id_idx").using("btree", table.userId.asc().nullsLast().op("text_ops")),
]);
...
export const riskEvents = pgTable("risk_events", {
	...
	index("risk_events_event_type_idx").using("btree", table.eventType.asc().nullsLast().op("text_ops")),
	index("risk_events_resolved_idx").using("btree", table.resolved.asc().nullsLast().op("bool_ops")),
	index("risk_events_severity_idx").using("btree", table.severity.asc().nullsLast().op("text_ops")),
	index("risk_events_timestamp_idx").using("btree", table.timestamp.asc().nullsLast().op("timestamp_ops")),
	index("risk_events_type_timestamp_idx").using("btree", table.eventType.asc().nullsLast().op("text_ops"), table.timestamp.asc().nullsLast().op("timestamp_ops")),
	index("risk_events_user_id_idx").using("btree", table.userId.asc().nullsLast().op("text_ops")),
	index("risk_events_user_severity_idx").using("btree", table.userId.asc().nullsLast().op("text_ops"), table.severity.asc().nullsLast().op("text_ops")),
]);
...
export const systemHealthMetrics = pgTable("system_health_metrics", {
	...
	index("system_health_metrics_service_idx").using("btree", table.service.asc().nullsLast().op("text_ops")),
	index("system_health_metrics_service_status_idx").using("btree", table.service.asc().nullsLast().op("text_ops"), table.status.asc().nullsLast().op("text_ops")),
	index("system_health_metrics_service_timestamp_idx").using("btree", table.service.asc().nullsLast().op("text_ops"), table.timestamp.asc().nullsLast().op("text_ops")),
	index("system_health_metrics_status_idx").using("btree", table.status.asc().nullsLast().op("text_ops")),
	index("system_health_metrics_timestamp_idx").using("btree", table.timestamp.asc().nullsLast().op("timestamp_ops")),
]);
...
export const workflowActivity = pgTable("workflow_activity", {
	...
	index("idx_workflow_activity_user_timestamp").using("btree", table.userId.asc().nullsLast().op("text_ops"), table.timestamp.asc().nullsLast().op("text_ops"), table.type.asc().nullsLast().op("timestamp_ops")),
	index("workflow_activity_activity_id_idx").using("btree", table.activityId.asc().nullsLast().op("text_ops")),
	index("workflow_activity_timestamp_idx").using("btree", table.timestamp.asc().nullsLast().op("timestamp_ops")),
...
export const workflowSystemStatus = pgTable("workflow_system_status", {
	...
	lastUpdate: timestamp("last_update", { mode: 'string' }).default(sql`CURRENT_TIMESTAMP`).notNull(),
	...
	index("workflow_system_status_user_id_idx").using("btree", table.userId.asc().nullsLast().op("text_ops")),
]);
...
export const apiCredentials = pgTable("api_credentials", {
	...
	index("api_credentials_user_provider_idx").using("btree", table.userId.asc().nullsLast().op("text_ops"), table.provider.asc().nullsLast().op("text_ops")),
	index("idx_api_credentials_user_active").using("btree", table.userId.asc().nullsLast().op("text_ops"), table.isActive.asc().nullsLast().op("text_ops"), table.updatedAt.asc().nullsLast().op("text_ops")).where(sql`(is_active = true)`),
	foreignKey({
			columns: [table.userId],
			foreignColumns: [user.id],
...
export const executionHistory = pgTable("execution_history", {
	...
	index("execution_history_snipe_target_action_status_idx").using("btree", table.snipeTargetId.asc().nullsLast().op("int4_ops"), table.action.asc().nullsLast().op("text_ops"), table.status.asc().nullsLast().op("text_ops")),
	index("execution_history_user_status_action_idx").using("btree", table.userId.asc().nullsLast().op("text_ops"), table.status.asc().nullsLast().op("text_ops"), table.action.asc().nullsLast().op("text_ops")),
	index("execution_history_user_symbol_time_idx").using("btree", table.userId.asc().nullsLast().op("text_ops"), table.symbolName.asc().nullsLast().op("timestamp_ops"), table.executedAt.asc().nullsLast().op("text_ops")),
	index("idx_execution_history_user_symbol").using("btree", table.userId.asc().nullsLast().op("timestamp_ops"), table.symbolName.asc().nullsLast().op("timestamp_ops"), table.executedAt.asc().nullsLast().op("text_ops")),
	foreignKey({
			columns: [table.userId],
			foreignColumns: [user.id],
...
export const snipeTargets = pgTable("snipe_targets", {
	...
	index("idx_snipe_targets_complex_lookup").using("btree", table.userId.asc().nullsLast().op("int4_ops"), table.symbolName.asc().nullsLast().op("timestamp_ops"), table.status.asc().nullsLast().op("text_ops"), table.priority.asc().nullsLast().op("text_ops"), table.createdAt.asc().nullsLast().op("text_ops")),
	index("idx_snipe_targets_user_status").using("btree", table.userId.asc().nullsLast().op("timestamp_ops"), table.status.asc().nullsLast().op("timestamp_ops"), table.createdAt.asc().nullsLast().op("text_ops")),
	index("snipe_targets_status_execution_time_idx").using("btree", table.status.asc().nullsLast().op("text_ops"), table.targetExecutionTime.asc().nullsLast().op("text_ops")),
	index("snipe_targets_user_status_priority_idx").using("btree", table.userId.asc().nullsLast().op("int4_ops"), table.status.asc().nullsLast().op("text_ops"), table.priority.asc().nullsLast().op("text_ops")),
	foreignKey({
			columns: [table.userId],
			foreignColumns: [user.id],
...
export const patternEmbeddings = pgTable("pattern_embeddings", {
	...
	index("idx_pattern_embeddings_analysis_composite").using("btree", table.symbolName.asc().nullsLast().op("timestamp_ops"), table.patternType.asc().nullsLast().op("text_ops"), table.confidence.asc().nullsLast().op("timestamp_ops"), table.isActive.asc().nullsLast().op("bool_ops"), table.createdAt.asc().nullsLast().op("float4_ops")),
	index("idx_pattern_embeddings_confidence_active").using("btree", table.confidence.asc().nullsLast().op("text_ops"), table.isActive.asc().nullsLast().op("text_ops"), table.patternType.asc().nullsLast().op("float4_ops")).where(sql`((confidence > (0.7)::double precision) AND (is_active = true))`),
	index("idx_pattern_embeddings_symbol_timestamp").using("btree", table.symbolName.asc().nullsLast().op("text_ops"), table.createdAt.asc().nullsLast().op("timestamp_ops"), table.confidence.asc().nullsLast().op("timestamp_ops")),
	index("pattern_embeddings_symbol_type_idx").using("btree", table.symbolName.asc().nullsLast().op("text_ops"), table.patternType.asc().nullsLast().op("text_ops")),
	index("pattern_embeddings_type_confidence_idx").using("btree", table.patternType.asc().nullsLast().op("text_ops"), table.confidence.asc().nullsLast().op("text_ops")),
	unique("pattern_embeddings_pattern_id_unique").on(table.patternId),
]);

export const patternSimilarityCache = pgTable("pattern_similarity_cache", {
	id: serial().primaryKey().notNull(),
	...
	index("idx_pattern_similarity_cache_pattern_similarity").using("btree", table.patternId1.asc().nullsLast().op("text_ops"), table.cosineSimilarity.asc().nullsLast().op("text_ops"), table.createdAt.asc().nullsLast().op("float4_ops")),
	index("pattern_similarity_cache_unique_pair_idx").using("btree", table.patternId1.asc().nullsLast().op("text_ops"), table.patternId2.asc().nullsLast().op("text_ops")),
	foreignKey({
...
export const positionSnapshots = pgTable("position_snapshots", {
	...
	index("position_snapshots_reconciliation_id_idx").using("btree", table.reconciliationId.asc().nullsLast().op("text_ops")),
	index("position_snapshots_snapshot_id_idx").using("btree", table.snapshotId.asc().nullsLast().op("text_ops")),
	index("position_snapshots_source_idx").using("btree", table.source.asc().nullsLast().op("text_ops")),
	index("position_snapshots_source_timestamp_idx").using("btree", table.source.asc().nullsLast().op("timestamp_ops"), table.timestamp.asc().nullsLast().op("timestamp_ops")),
	index("position_snapshots_symbol_idx").using("btree", table.symbol.asc().nullsLast().op("text_ops")),
	index("position_snapshots_timestamp_idx").using("btree", table.timestamp.asc().nullsLast().op("timestamp_ops")),
	index("position_snapshots_user_id_idx").using("btree", table.userId.asc().nullsLast().op("text_ops")),
	index("position_snapshots_user_symbol_idx").using("btree", table.userId.asc().nullsLast().op("text_ops"), table.symbol.asc().nullsLast().op("text_ops")),
	foreignKey({
			columns: [table.userId],
			foreignColumns: [user.id],
...
export const simulationSessions = pgTable("simulation_sessions", {
	...
	index("simulation_sessions_start_time_idx").using("btree", table.startTime.asc().nullsLast().op("timestamp_ops")),
	index("simulation_sessions_status_idx").using("btree", table.status.asc().nullsLast().op("text_ops")),
	index("simulation_sessions_user_id_idx").using("btree", table.userId.asc().nullsLast().op("text_ops")),
	foreignKey({
			columns: [table.userId],
			foreignColumns: [user.id],
...
export const simulationTrades = pgTable("simulation_trades", {
	...
	index("simulation_trades_realized_idx").using("btree", table.realized.asc().nullsLast().op("bool_ops")),
	index("simulation_trades_session_id_idx").using("btree", table.sessionId.asc().nullsLast().op("text_ops")),
	index("simulation_trades_symbol_idx").using("btree", table.symbol.asc().nullsLast().op("text_ops")),
	index("simulation_trades_timestamp_idx").using("btree", table.timestamp.asc().nullsLast().op("timestamp_ops")),
...
export const tradingStrategies = pgTable("trading_strategies", {
	...
	index("idx_trading_strategies_active_user").using("btree", table.userId.asc().nullsLast().op("text_ops"), table.status.asc().nullsLast().op("text_ops"), table.updatedAt.asc().nullsLast().op("timestamp_ops")),
	index("trading_strategies_status_idx").using("btree", table.status.asc().nullsLast().op("text_ops")),
	index("trading_strategies_symbol_idx").using("btree", table.symbol.asc().nullsLast().op("text_ops")),
	index("trading_strategies_symbol_status_idx").using("btree", table.symbol.asc().nullsLast().op("text_ops"), table.status.asc().nullsLast().op("text_ops")),
	index("trading_strategies_template_idx").using("btree", table.strategyTemplateId.asc().nullsLast().op("int4_ops")),
	index("trading_strategies_user_idx").using("btree", table.userId.asc().nullsLast().op("text_ops")),
	index("trading_strategies_user_status_idx").using("btree", table.userId.asc().nullsLast().op("text_ops"), table.status.asc().nullsLast().op("text_ops")),
	index("trading_strategies_user_symbol_idx").using("btree", table.userId.asc().nullsLast().op("text_ops"), table.symbol.asc().nullsLast().op("text_ops")),
	foreignKey({
			columns: [table.userId],
			foreignColumns: [user.id],
...
export const strategyConfigBackups = pgTable("strategy_config_backups", {
	id: serial().primaryKey().notNull(),
	...
	index("strategy_config_backups_active_idx").using("btree", table.isActive.asc().nullsLast().op("bool_ops")),
	index("strategy_config_backups_reason_idx").using("btree", table.backupReason.asc().nullsLast().op("text_ops")),
	index("strategy_config_backups_strategy_idx").using("btree", table.strategyId.asc().nullsLast().op("int4_ops")),
	index("strategy_config_backups_version_idx").using("btree", table.version.asc().nullsLast().op("int4_ops")),
	foreignKey({
...
export const strategyPerformanceMetrics = pgTable("strategy_performance_metrics", {
	id: serial().primaryKey().notNull(),
	userId: text("user_id").notNull(),
	strategyId: integer("strategy_id").notNull(),
	...
	calculatedAt: timestamp("calculated_at", { mode: 'string' }).default(sql`CURRENT_TIMESTAMP`).notNull(),
	createdAt: timestamp("created_at", { mode: 'string' }).default(sql`CURRENT_TIMESTAMP`).notNull(),
}, (table) => [
	index("strategy_performance_metrics_period_idx").using("btree", table.periodStart.asc().nullsLast().op("timestamp_ops"), table.periodEnd.asc().nullsLast().op("timestamp_ops")),
	index("strategy_performance_metrics_period_type_idx").using("btree", table.periodType.asc().nullsLast().op("text_ops")),
	index("strategy_performance_metrics_strategy_idx").using("btree", table.strategyId.asc().nullsLast().op("int4_ops")),
	index("strategy_performance_metrics_strategy_period_idx").using("btree", table.strategyId.asc().nullsLast().op("timestamp_ops"), table.periodStart.asc().nullsLast().op("int4_ops")),
	index("strategy_performance_metrics_user_idx").using("btree", table.userId.asc().nullsLast().op("text_ops")),
	index("strategy_performance_metrics_user_period_idx").using("btree", table.userId.asc().nullsLast().op("text_ops"), table.periodStart.asc().nullsLast().op("text_ops")),
	foreignKey({
			columns: [table.userId],
			foreignColumns: [user.id],
...
export const strategyPhaseExecutions = pgTable("strategy_phase_executions", {
	id: serial().primaryKey().notNull(),
	userId: text("user_id").notNull(),
	strategyId: integer("strategy_id").notNull(),
	...
	index("strategy_phase_executions_phase_idx").using("btree", table.phaseNumber.asc().nullsLast().op("int4_ops")),
	index("strategy_phase_executions_status_idx").using("btree", table.executionStatus.asc().nullsLast().op("text_ops")),
	index("strategy_phase_executions_strategy_idx").using("btree", table.strategyId.asc().nullsLast().op("int4_ops")),
	index("strategy_phase_executions_strategy_phase_idx").using("btree", table.strategyId.asc().nullsLast().op("int4_ops"), table.phaseNumber.asc().nullsLast().op("int4_ops")),
	index("strategy_phase_executions_strategy_status_idx").using("btree", table.strategyId.asc().nullsLast().op("int4_ops"), table.executionStatus.asc().nullsLast().op("int4_ops")),
	index("strategy_phase_executions_user_idx").using("btree", table.userId.asc().nullsLast().op("text_ops")),
	index("strategy_phase_executions_user_strategy_idx").using("btree", table.userId.asc().nullsLast().op("int4_ops"), table.strategyId.asc().nullsLast().op("int4_ops")),
	foreignKey({
			columns: [table.userId],
			foreignColumns: [user.id],
...
export const strategyTemplates = pgTable("strategy_templates", {
	...
	index("strategy_templates_risk_level_idx").using("btree", table.riskLevel.asc().nullsLast().op("text_ops")),
	index("strategy_templates_strategy_id_idx").using("btree", table.strategyId.asc().nullsLast().op("text_ops")),
	index("strategy_templates_type_idx").using("btree", table.type.asc().nullsLast().op("text_ops")),
	index("strategy_templates_usage_count_idx").using("btree", table.usageCount.asc().nullsLast().op("int4_ops")),
...
export const transactionLocks = pgTable("transaction_locks", {
	...
	acquiredAt: timestamp("acquired_at", { mode: 'string' }).default(sql`CURRENT_TIMESTAMP`).notNull(),
	expiresAt: timestamp("expires_at", { mode: 'string' }).notNull(),
	...
	index("idx_transaction_locks_resource_status").using("btree", table.resourceId.asc().nullsLast().op("timestamp_ops"), table.status.asc().nullsLast().op("timestamp_ops"), table.expiresAt.asc().nullsLast().op("timestamp_ops")).where(sql`(status = 'active'::text)`),
	index("transaction_locks_owner_status_idx").using("btree", table.ownerId.asc().nullsLast().op("text_ops"), table.status.asc().nullsLast().op("text_ops")),
	index("transaction_locks_resource_status_idx").using("btree", table.resourceId.asc().nullsLast().op("text_ops"), table.status.asc().nullsLast().op("text_ops")),
...
export const transactionQueue = pgTable("transaction_queue", {
	...
	index("transaction_queue_resource_status_idx").using("btree", table.resourceId.asc().nullsLast().op("text_ops"), table.status.asc().nullsLast().op("text_ops")),
	index("transaction_queue_status_priority_idx").using("btree", table.status.asc().nullsLast().op("timestamp_ops"), table.priority.asc().nullsLast().op("timestamp_ops"), table.queuedAt.asc().nullsLast().op("int4_ops")),
	foreignKey({
...
export const transactions = pgTable("transactions", {
	...
	snipeTargetId: integer("snipe_target_id"),
	notes: text(),
	transactionTime: timestamp("transaction_time", { mode: 'string' }).default(sql`CURRENT_TIMESTAMP`).notNull(),
	createdAt: timestamp("created_at", { mode: 'string' }).default(sql`CURRENT_TIMESTAMP`).notNull(),
	updatedAt: timestamp("updated_at", { mode: 'string' }).default(sql`CURRENT_TIMESTAMP`).notNull(),
}, (table) => [
	index("idx_transactions_user_timestamp").using("btree", table.userId.asc().nullsLast().op("text_ops"), table.createdAt.asc().nullsLast().op("timestamp_ops"), table.status.asc().nullsLast().op("timestamp_ops")),
	index("transactions_symbol_time_idx").using("btree", table.symbolName.asc().nullsLast().op("text_ops"), table.transactionTime.asc().nullsLast().op("text_ops")),
	index("transactions_user_status_idx").using("btree", table.userId.asc().nullsLast().op("text_ops"), table.status.asc().nullsLast().op("text_ops")),
	index("transactions_user_time_idx").using("btree", table.userId.asc().nullsLast().op("timestamp_ops"), table.transactionTime.asc().nullsLast().op("text_ops")),
	foreignKey({
			columns: [table.userId],
			foreignColumns: [user.id],
...
export const userPreferences = pgTable("user_preferences", {
	...
	index("idx_user_preferences_user_key").using("btree", table.userId.asc().nullsLast().op("timestamp_ops"), table.updatedAt.asc().nullsLast().op("text_ops")),
...
export const coinActivities = pgTable("coin_activities", {
	...
	index("coin_activities_active_currency_idx").using("btree", table.isActive.asc().nullsLast().op("bool_ops"), table.currency.asc().nullsLast().op("text_ops")),
	index("coin_activities_activity_type_idx").using("btree", table.activityType.asc().nullsLast().op("text_ops")),
	index("coin_activities_currency_idx").using("btree", table.currency.asc().nullsLast().op("text_ops")),
	index("coin_activities_discovered_at_idx").using("btree", table.discoveredAt.asc().nullsLast().op("timestamp_ops")),
	index("coin_activities_is_active_idx").using("btree", table.isActive.asc().nullsLast().op("bool_ops")),
	index("coin_activities_type_discovered_idx").using("btree", table.activityType.asc().nullsLast().op("text_ops"), table.discoveredAt.asc().nullsLast().op("text_ops")),
	index("coin_activities_vcoin_id_idx").using("btree", table.vcoinId.asc().nullsLast().op("text_ops")),
