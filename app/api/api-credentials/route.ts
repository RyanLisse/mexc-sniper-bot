...
export async function GET(request: NextRequest) {
  try {
    ...
    const response = {
      success: true,
      data: {
        credentials: mockCredentials[provider as keyof typeof mockCredentials] || mockCredentials.mexc,
        provider,
        userId: userId || null,
  ...
  try {
    ...
    const response = {
      ...
      data: {
        ...
        provider,
        userId: userId || null,
        message: isValid ? 'Credentials stored successfully' : 'Invalid credentials provided'
      },
      message: isValid ? 'Credentials updated successfully' : 'Failed to validate credentials'
    };
