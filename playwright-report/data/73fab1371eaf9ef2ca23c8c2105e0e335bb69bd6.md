...
- Name: API Key Management >> should save and retrieve API keys through preferences API
- Location: /Users/neo/Developer/mexc-sniper-bot/all-tests/e2e-tests/api-keys.spec.ts:79:7
