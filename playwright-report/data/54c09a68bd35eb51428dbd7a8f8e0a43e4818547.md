...
- Name: Dashboard Page >> should display upcoming coins section
- Location: /Users/neo/Developer/mexc-sniper-bot/all-tests/e2e-tests/dashboard.spec.ts:38:7
...
Call log:
  - navigating to "http://localhost:3008/dashboard", waiting until "load"
    ...
    at /Users/neo/Developer/mexc-sniper-bot/all-tests/e2e-tests/dashboard.spec.ts:39:16
```
