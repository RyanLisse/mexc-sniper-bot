...
- Name: Authentication Frontend Integration >> Emergency dashboard works with authenticated users
- Location: /Users/neo/Developer/mexc-sniper-bot/all-tests/e2e-tests/test-auth-frontend.spec.ts:250:7
...
Call log:
  - navigating to "http://localhost:3008/auth", waiting until "load"
    ...
    at /Users/neo/Developer/mexc-sniper-bot/all-tests/e2e-tests/test-auth-frontend.spec.ts:254:11
```
