...
- Name: Dashboard Page >> should handle refresh calendar button
- Location: /Users/neo/Developer/mexc-sniper-bot/all-tests/e2e-tests/dashboard.spec.ts:62:7
...
Call log:
  - navigating to "http://localhost:3008/dashboard", waiting until "load"
    ...
    at /Users/neo/Developer/mexc-sniper-bot/all-tests/e2e-tests/dashboard.spec.ts:63:16
```
